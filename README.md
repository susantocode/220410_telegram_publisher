# Send Text and Images to Telegram

Covers both sending simple text messages and sending text with an image directly from MT4 and MT5.

The code is written as a script but the functions can be moved to a library or inserted directly in an expert.
